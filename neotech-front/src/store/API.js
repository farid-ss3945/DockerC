...
export const API = createApi({
  ...
  endpoints: builder => ({
    ...
    getParentCategories: builder.query({
      query: () => ({ url: '/api/v1/Categories/root', method: 'GET' }),
      providesTags: ['Categories'],
    }),

    getSubCategories: builder.query({
      query: (id) => ({ url: `/api/v1/Categories/${id}/subcategories`, method: 'GET' }),
      providesTags: ['Categories'],
    }),

    getCategory: builder.query({
      query: (slug) => ({ url: `/api/v1/Categories/slug/${slug}`, method: 'GET' }),
      providesTags: ['Categories'],
    }),
    ...
    addCategory: builder.mutation({
      query: ({ name, imageUrl, description, sortOrder, parentCategoryId }) => ({
        ...
        method: 'POST',
        body: { name, description, imageUrl, sortOrder, parentCategoryId },
      }),
    ...
    editCategory: builder.mutation({
      query: ({ name, imageUrl, description, sortOrder, id, isActive }) => ({
        ...
        method: 'PUT',
        body: { name, description, imageUrl, isActive, sortOrder },
      }),
      invalidatesTags: ['Categories'],
    }),
    ...
    getUsers: builder.query({
      query: () => ({ url: '/api/v1/Admin/Users', method: 'GET' }),
      providesTags: ['Users'],
    }),

    getUserStatics: builder.query({
      query: () => ({ url: '/api/v1/Admin/users/statistics', method: 'GET' }),
      providesTags: ['Users'],
    }),

    getUserRoles: builder.query({
      query: () => ({ url: '/api/v1/Admin/users/roles', method: 'GET' }),
      providesTags: ['Users'],
    }),
    ...
    changePassword: builder.mutation({
      query: ({ newPass, currentPass, confirmNewPassword }) => ({
        ...
        method: 'POST',
        body: { currentPassword: currentPass, newPassword: newPass, confirmNewPassword },
      }),
      invalidatesTags: ['Auth'],
    }),

    getCategories: builder.query({
      query: () => ({ url: '/api/v1/Categories', method: 'GET' }),
      providesTags: ['Categories'],
    }),
    ...
    activateUser: builder.mutation({
      query: ({ id }) => ({ url: `/api/v1/Admin/users/${id}/activate`, method: 'POST' }),
      invalidatesTags: ['Users'],
    }),

    deActivateUser: builder.mutation({
      query: ({ id }) => ({ url: `/api/v1/Admin/users/${id}/deactivate`, method: 'POST' }),
      invalidatesTags: ['Users'],
    }),
    ...
    getProducts: builder.query({
      query: () => ({ url: '/api/v1/Products', method: 'GET' }),
    ...
    getRecommendedPage: builder.query({
      query: ({ productId, categoryId, limit = 4, page = 1, pageSize = 4 } = {}) => ({
        ...
        method: 'GET',
        params: { ProductId: productId, CategoryId: categoryId, Limit: limit, Page: page, PageSize: pageSize },
      }),
      providesTags: ['Products'],
    }),
    ...
    getProductsBrand: builder.query({
      query: ({ brandSlug }) => ({ url: `/api/v1/Products/brand/${brandSlug}`, method: 'GET' }),
    }),

    getBrands: builder.query({
      query: () => ({ url: '/api/v1/Admin/brands', method: 'GET' }),
    }),

    getBrand: builder.query({
      query: ({ id }) => ({ url: `/api/v1/Admin/brands/${id}`, method: 'GET' }),
    }),
    ...
    getProductsSummary: builder.query({
      query: () => ({ url: '/api/v1/Admin/products/stock/summary', method: 'GET' }),
      providesTags: ['Products'],
    }),

    addProduct: builder.mutation({
      query: formData => ({ url: '/api/v1/Products/with-image', method: 'POST', body: formData }),
    ...
    editProduct: builder.mutation({
      query: ({ name, description, shortDescription, isActive, isHotDeal, stockQuantity, categoryId, id }) => ({
        ...
        method: 'PUT',
        body: { name, description, shortDescription, isActive, isHotDeal, stockQuantity, categoryId },
      }),
      invalidatesTags: ['Products'],
    }),

    filterProducts: builder.mutation({
      query: formData => ({ url: '/api/v1/Products/filter', method: 'POST', body: formData }),
    }),
    ...
    deleteProductImage: builder.mutation({
      query: ({ id }) => ({ url: `/api/v1/Products/images/${id}`, method: 'DELETE' }),
    }),
    ...
    getProductSpecifications: builder.query({
      query: (id) => ({ url: `/api/v1/Products/${id}/specifications`, method: 'GET' }),
      providesTags: (result, error, id) => [{ type: 'Products', id }],
    }),

    getProductsCategorySlug: builder.query({
      query: (categorySlug) => ({ url: `/api/v1/Products/category/slug/${categorySlug}`, method: 'GET' }),
    ...
    addProductSpecifications: builder.mutation({
      query: ({ id, productId, specificationGroups }) => ({
        ...
        method: 'POST',
        body: { productId, specificationGroups },
      }),
      invalidatesTags: (result, error, { id }) => [{ type: 'Products', id }],
    }),
    ...
    deleteProductSpecifications: builder.mutation({
      query: ({ id }) => ({ url: `/api/v1/Products/${id}/specifications`, method: 'DELETE' }),
      invalidatesTags: (result, error, { id }) => [{ type: 'Products', id }],
    }),

    // *BANNERS*
    getBanners: builder.query({
      query: () => ({ url: '/api/v1/Admin/banners', method: 'GET' }),
      providesTags: ['Banners'],
    }),

    deleteBanner: builder.mutation({
      query: ({ id }) => ({ url: `/api/v1/Admin/banners/${id}`, method: 'DELETE' }),
      invalidatesTags: ['Banners'],
    }),

    addBanner: builder.mutation({
      query: formData => ({ url: '/api/v1/Admin/banners/with-image', method: 'POST', body: formData }),
      invalidatesTags: ['Banners'],
    }),

    updateBanner: builder.mutation({
      query: ({ id, ...data }) => ({ url: `/api/v1/Admin/banners/${id}`, method: 'PUT', body: data }),
      invalidatesTags: ['Banners'],
    }),
    ...
    uploadMobileImage: builder.mutation({
      query: ({ id, imageFile }) => {
        ...
        return { url: `/api/v1/Admin/banners/${id}/upload-mobile-image`, method: 'POST', body: formData };
      },
      invalidatesTags: ['Banners'],
    }),
    ...
    uploadDesktopImage: builder.mutation({
      query: ({ id, imageFile }) => {
        const formData = new FormData();
        formData.append('imageFile', imageFile);
        return { url: `/api/v1/Admin/banners/${id}/upload-image`, method: 'POST', body: formData };
      },
      invalidatesTags: ['Banners'],
    }),
    ...
    getFilters: builder.query({
      query: () => ({ url: '/api/v1/Products/filters', method: 'GET' }),
    ...
    addFilter: builder.mutation({
      query: ({ name, isActive, sortOrder, options }) => ({
        ...
        method: 'POST',
        body: { name, type: 0, isActive, sortOrder: sortOrder ?? 0, options },
      }),
      invalidatesTags: ['Filters'],
    }),

    removeFilter: builder.mutation({
      query: ({ id }) => ({ url: `/api/v1/Admin/filters/${id}`, method: 'DELETE' }),
      invalidatesTags: ['Filters'],
    }),
    ...
    removeAllFiltersFromProduct: builder.mutation({
      query: ({ productId }) => ({ url: `/api/v1/Admin/products/${productId}/filters`, method: 'DELETE' }),
      invalidatesTags: ['Filters'],
    }),
    ...
    updateFilter: builder.mutation({
      query: ({ id, ...data }) => ({ url: `/api/v1/Admin/filters/${id}`, method: 'PUT', body: data }),
      invalidatesTags: ['Filters'],
    }),
    ...
    getCategoryFilters: builder.query({
      query: (categoryId) => ({ url: `/api/v1/Products/category/${categoryId}/filters`, method: 'GET' }),
    ...
    getCartCount: builder.query({
      query: () => ({ url: '/api/v1/Cart/count', method: 'GET' }),
      providesTags: ['Cart'],
    }),
    ...
    removeCartItem: builder.mutation({
      query: ({ id }) => ({ url: `/api/v1/Cart/items/${id}`, method: 'DELETE' }),
      invalidatesTags: ['Cart'],
    }),
    ...
    createWhatsappOrder: builder.mutation({
      query: (orderData) => ({ url: '/api/v1/Cart/whatsapp-order', method: 'POST', body: orderData }),
      invalidatesTags: ['Cart'],
    }),

    quickOrder: builder.mutation({
      query: (orderData) => ({ url: '/api/v1/Cart/quick-order', method: 'POST', body: orderData }),
    }),

    // *FAVORITES*
    addFavorite: builder.mutation({
      query: ({ productId }) => ({ url: '/api/v1/Favorites', method: 'POST', body: { productId } }),
      invalidatesTags: ['Favorites', 'Products'],
    }),

    removeFavorite: builder.mutation({
      query: ({ productId }) => ({ url: `/api/v1/Favorites/${productId}`, method: 'DELETE' }),
      invalidatesTags: ['Favorites', 'Products'],
    }),
    ...
    getFavoritesCount: builder.query({
      query: () => ({ url: '/api/v1/Favorites/count', method: 'GET' }),
      providesTags: ['Favorites'],
    }),

    getFavoriteStatus: builder.query({
      query: ({ productId }) => ({ url: `/api/v1/Favorites/status/${productId}`, method: 'GET' }),
      providesTags: (result, error, { productId }) => [{ type: 'Favorites', id: productId }],
    }),

    toggleFavorite: builder.mutation({
      query: ({ productId }) => ({ url: `/api/v1/Favorites/toggle/${productId}`, method: 'POST' }),
      invalidatesTags: ['Favorites', 'Products'],
    }),

    bulkCheckFavoriteStatus: builder.mutation({
      query: (productIds) => ({ url: '/api/v1/Favorites/bulk-status', method: 'POST', body: productIds }),
    }),

    clearFavorites: builder.mutation({
      query: () => ({ url: '/api/v1/Favorites/clear', method: 'DELETE' }),
    ...
    removeFile: builder.mutation({
      query: (id) => ({ url: `/api/v1/Admin/files/${id}`, method: 'DELETE' }),
      invalidatesTags: ['Files'],
    }),

    uploadFile: builder.mutation({
      query: (formData) => ({ url: '/api/v1/Admin/files/upload', method: 'POST', body: formData }),
      invalidatesTags: ['Files'],
    }),

    getProductPdfs: builder.query({
      query: () => ({ url: '/api/v1/Admin/product-pdfs', method: 'GET' }),
      providesTags: ['ProductPdfs'],
    }),

    getProductPdfById: builder.query({
      query: ({ id }) => ({ url: `/api/v1/Admin/product-pdfs/${id}`, method: 'GET' }),
    ...
    deleteProductPdf: builder.mutation({
      query: ({ id }) => ({ url: `/api/v1/Admin/product-pdfs/${id}`, method: 'DELETE' }),
      invalidatesTags: ['ProductPdfs', 'Products'],
    }),
    ...
    getBrandsAdmin: builder.query({
      query: () => ({ url: '/api/v1/Brands', method: 'GET' }),
      providesTags: ['Brands'],
    }),
    ...
    editBrand: builder.mutation({
      query: ({ id, ...data }) => ({ url: `/api/v1/Brands/${id}`, method: 'PUT', body: data }),
      invalidatesTags: ['Brands'],
    }),
    ...
    deleteBrand: builder.mutation({
      query: ({ id }) => ({ url: `/api/v1/Brands/${id}`, method: 'DELETE' }),
      invalidatesTags: ['Brands'],
    }),
  }),
});
